	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li><a href="#">Viko</a></li>
				<li class="active">Розетка без заземления Carmen – кремовый</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							<h2 class="product-name">Розетка без заземления Carmen – кремовый</h2>
							<h3 class="product-price">4.16 BUN</h3>
							<p><strong>Статус:</strong> В наличии</p>
							<p><strong>Бренд:</strong> Viko</p>
							<p>Штепсельная розетка без заземления Viko Carmen (Вико Кармен).
Устанавливается в тех помещениях, где в электропроводке отсутствует заземляющая жила. </p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab1" class="tab-pane fade in active">
									<p>Штепсельная розетка без заземления Viko Carmen (Вико Кармен).</p>
									<p>Устанавливается в тех помещениях, где в электропроводке отсутствует заземляющая жила. Корпус сделан из пластикового изоляционного материала с двумя отверстиями, с обратной стороны к розетке подсоединяются два контакта электропроводки.</p>
									<p>Производитель комплектует розетку одинарной рамкой, если устанавливать блок с большим количеством точек, необходимо приобрести соответствующую рамку: на 2 гнезда, 3 гнезда, 4 гнезда, 5 гнёзд, 6 гнёзд.
