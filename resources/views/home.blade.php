...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header" align="center"><h2 style="padding-top: 15px;">Кабинет администратора</h2></div>
                ...
                <div class="card-body">
                    <form action = "{{asset('home')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class = "custom-file">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn" style="background-color: #f8694a; color: white;">Отправить</button>
                            </div>
                    </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{asset('home/edit/'.$one->id)}}" class="btn btn-block" style="background-color: #f8694a; color: white;">Редактировать</a>
