	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li><a href="#">Viko</a></li>
				<li class="active">Розетка с заземлением Carmen – кремовый</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							<h2 class="product-name">Розетка с заземлением Carmen – кремовый</h2>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab1" class="tab-pane fade in active">
									<p>Основной задачей заземления является защита от удара электротоком.</p> 
									<p>Наличие заземления у розетки делает работу сложных бытовых устройств: стиральной машины, компьютера, видео и аудиоаппаратуры и т.д., безопасной и стабильной.</p>
