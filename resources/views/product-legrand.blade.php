	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active">Розетка с заземлением Quteo – белый</li> 
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							<h2 class="product-name">Розетка с заземлением Quteo – белый</h2>
							<h3 class="product-price">5.66 BUN</h3>
							<p><strong>Статус:</strong> В наличии</p>
							<p><strong>Бренд:</strong> Legrand</p>
							<p>Розетка с заземлением наружного (открытого) монтажа Legrand Quteo.</p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab1" class="tab-pane fade in active">
									<p>Розетка с заземлением наружного (открытого) монтажа Legrand Quteo
									</p>
								</div>
